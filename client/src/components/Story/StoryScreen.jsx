...
const Story = () => {
  ...
  return (
    <div className={classes.body}>
      ...
      <div className={classes.Talking_with_friends_Button}></div>

      <div className={classes.The_boy_and_his_bike_Button}></div>

      <div className={classes.Playing_with_friends_Button}></div>
